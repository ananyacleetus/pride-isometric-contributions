...
COLORS = [new obelisk.CubeColor().getByHorizontalColor(0x83ba6d), new obelisk.CubeColor().getByHorizontalColor(0xdbab3b), new obelisk.CubeColor().getByHorizontalColor(0x447cbf), new obelisk.CubeColor().getByHorizontalColor(0x781c81), new obelisk.CubeColor().getByHorizontalColor(0xd92120)];

//COLORS = [new obelisk.CubeColor().getByHorizontalColor(0xcc6677), new obelisk.CubeColor().getByHorizontalColor(0x332288), new obelisk.CubeColor().getByHorizontalColor(0x88ccee), new obelisk.CubeColor().getByHorizontalColor(0x117733), new obelisk.CubeColor().getByHorizontalColor(0xddcc77)];

//COLORS = [new obelisk.CubeColor().getByHorizontalColor(0xff8080), new obelisk.CubeColor().getByHorizontalColor(0xe680ff), new obelisk.CubeColor().getByHorizontalColor(0x80b2ff), new obelisk.CubeColor().getByHorizontalColor(0x80ffb3), new obelisk.CubeColor().getByHorizontalColor(0xe5ff80)];

//COLORS = [new obelisk.CubeColor().getByHorizontalColor(0xb58900), new obelisk.CubeColor().getByHorizontalColor(0x859900), new obelisk.CubeColor().getByHorizontalColor(0x268bd2), new obelisk.CubeColor().getByHorizontalColor(0x6c71c4), new obelisk.CubeColor().getByHorizontalColor(0xdc322f)];

  // COLORS = [new obelisk.CubeColor().getByHorizontalColor(getRandomColor()), new obelisk.CubeColor().getByHorizontalColor(getRandomColor()), new obelisk.CubeColor().getByHorizontalColor(getRandomColor()), new obelisk.CubeColor().getByHorizontalColor(getRandomColor()), new obelisk.CubeColor().getByHorizontalColor(getRandomColor())];
